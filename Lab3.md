...
##was created function my_ifelse with different conditions such as У<Ф, У>Ф, У<=Ф, У>=Ф, У==Ф.With help of button "run" this function was printed in console.
...
```R
```
4.‘ункц≥€ columnmean(x, removeNA), €ка розраховуЇ середнЇ значенн€
